<?php
/* add_action( 'tiny_mce_before_init', 'add_preview_support' );

if ( ! function_exists( 'add_preview_support' ) ) {
  function add_preview_support(){
    add_action( 'init', 'awi_preview' );
  }
}

if ( ! function_exists( 'awi_preview' ) ) {
  function awi_preview() {
